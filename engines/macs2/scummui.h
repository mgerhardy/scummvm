...
private:
	// Layout constants
	static constexpr int kUITop = 200;
	static constexpr int kUIHeight = 56;
	static constexpr int kSentenceY = 200;
	static constexpr int kSentenceH = 12;
	static constexpr int kVerbY = 212;
	static constexpr int kVerbW = 80;
	static constexpr int kVerbH = 22;
	static constexpr int kVerbCols = 2;
	static constexpr int kVerbRows = 2;
	static constexpr int kInvX = 160;
	static constexpr int kInvItemW = 32;
	static constexpr int kInvItemH = 22;
	static constexpr int kInvCols = 4;
	static constexpr int kInvRows = 2;
	static constexpr int kInvArrowW = 16;
